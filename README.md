<h1 align="center">Hi 👋, I'm IntelliZhang</h1>
...
------------------------------------
## Demonstration from 3 private repositories ##

### 1. Computer Vision: Multiclass Semantic Segmentation of cartridge images ###
   
The purpose of this repo is automated detection of Region of Interest (Breech Face/BF and Firing Pin/FP) in cartridge case images using deep learning - U-Net model and FCNs model, automated draw direction arrow from FP to firing pin drag by cv2.drawContours.

IoU         |    U-Net   |   FCNs
------------|------------|-----------
 Background |   99.27%   |  98.74%
 BF     |   95.98%   |  93.75%
 FP     |   87.29%   |  82.39%
...
FP and firing pin drag will be automatically detected by cv2.findContours. The center of each contour will be located and an arrow line will be draw from the center for FP to the center of firing pin drag by cv2.arrowedLine.

### 2. NLP Sentiment Analysis with 10 different models(vectorizers) ###

Perform NLP Sentiment Analysis by:

1. SVM with BoW (Bag-of-Words)
2. SVM with TF-IDF (Term Frequency — Inverse Document Frequency)
3. SVM with custom Word2Vec
4. SVM with pre-trained Word2Vec model (Google News 300)
5. Vanilla RNN model
6. LSTM model
7. GRU model
8. Bi-Directional LSTM model
9. Pre-trained Transformer_based model - DistilBERT
10. Pre-trained Transformer_based model - Roberta

### 3. Data Analysis with 9 different Machine Learning Models ###

Perform classification analysis by 9 different ML models and the results are:

Model no.    |   Model           |   Accuracy   |     AUC     
----|-------------------|--------------|------------
1   | Linear Regression | 0.1054 (MSE) |    N/A
2   | Logistic Regression | 99.83% | 0.71
3   | Decision Tree | 99.97% | 0.94
4   | SVM | 99.92% | 0.67
5   | Naive Bayes | 99.30% | 0.58
6   | KNN | 99.94% | 0.84
7   | Random Forest | 99.97% | 0.90
8   | XGBoost | 99.93% | 0.74
9   | ANN | 99.84% (approx.) | N/A
